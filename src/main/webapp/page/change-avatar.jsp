...
<body>
	<div id="stage">
		...
		<div id="mainer" style="min-height: 24px;">
			<div id="mainer-inner">
				<div id="block-main">
						...
						<div id="area-cont-right">
							...
							<div id="block-banner-right" class="block banner">
								<a href="page/profile.jsp" class="tab"><i class="icon"></i>编辑资料</a><a
									href="page/change-avatar.jsp" class="tab active"><i
									class="icon"></i>修改头像</a>
							</div>
							<div id="block-first" class="block">
								<div class="banner">
									<p class="tab fixed">
										修改头像<span class="hint">Change Avatar</span>
									</p>
								</div>
								<div class="mainer">
									<div id="area-avatar-personal">
										<p class="alert alert-warning">请勿使用包含不良信息或敏感内容的图片作为用户头像。</p>
										<div id="flash-avatar-upload" style="visibility: visible;"></div>
									</div>
								</div>
							</div>
