			...
			<div class="" id="sub-guide">
				<div id="sub-guide-inner">
					...
					<div style="opacity: 1; left: 198.4px;"
						class="unit channel-dance c2 sc2 wc2 swc2 active">
...
#block-first .unit .r input {
	width: 320px
}

#block-first .unit .r textarea {
	width: 320px
}
...
@media screen and (min-width:1440px) {
	...
	#block-first .unit .r #editor-cont-newmail {
		width: 830px !important
	}
	.edui-popup-content.edui-default{width:auto !important; height: auto !important; z-index:2 !important;}
}
</style>
							<div id="block-title-banner">
								<p>新信件</p>
								<div>
									<a href="http://www.acfun.cn/member/">AcFun</a><span class="d">New
										Mail</span>
								</div>
								<span class="clearfix"></span>
							</div>
							<div id="block-banner-right" class="block banner">
								<a href="page/mail.jsp" class="tab"><i class="icon"></i>私信</a><a
									href="page/mail-new.jsp" class="tab active"><i class="icon"></i>新信件</a>
							</div>
							<div id="block-first" class="block">
								<div class="mainer form">
									<div class="unit">
										...
										<div class="r">
											<input required="required" placeholder="请输入收件人用户名"
												id="ipt-name-newmail" data-name="收件人用户名" data-length="1,50"
												class="name error">
										</div>
										<span class="clearfix"></span>
									</div>
									<div class="unit">
										...
										<div class="r">
											<div style="width: 100%; z-index: 2;" class="edui-container">
												
												<textarea id="container" name="container"
													style="height: 250px; margin: 0 auto;;"></textarea>
									...
									<div class="unit-tool">
										<div class="l">
											<button class="btn success do">
												<i class="icon icon-check-circle-o"></i>发送信息
											</button>
										</div>
										<div class="r"></div>
										<span class="clearfix"></span>
							...
							<script>(function(){$.require("editor",function(){var n,t,e,i,r;return n=$("#block-first"),i=n.find("div.form:eq(0)"),t=i.find("button.do:eq(0)"),$.extend(window.UMEDITOR_CONFIG,{toolbar:["bold italic underline strikethrough | forecolor fontsize | emotion image "],autoFloatEnabled:!1,funcCtrlEnter:function(){return t.click()},initialFrameWidth:"100%",initialFrameHeight:160,autoHeightEnabled:!1,zIndex:2}),UM.delEditor("editor-cont-newmail"),e=UM.getEditor("editor-cont-newmail"),r=function(n){return $.info(n),t.info(n)},i.setup({finish:function(){return $.hash("username")?$("#ipt-name-newmail").val(decodeURIComponent($.trim($.hash("username")))).keyup():void 0},callback:function(){var n,o,a,l;return user.userGroupLevel<1?(o=($$(window).width()-550)/2,n=$(this),void n.unfold({src:"../project/sanae/html/warning",id:"win-banana",icon:"warning",title:"",width:528,height:177,left:o,top:($$(window).height()-348)/2.5+$$(window).scrollTop(),curtain:!0,callback:function(){var e;return e=$("#win-banana"),e.css({left:o}),e.find(".pp .h").html("您的账号权限不能发送私信，你可以通过"),e.find(".pp a").html("游戏答题"),e.find(".pp .f").html("激活。"),t=e.find(".btn"),t.html("答题激活"),t.attr({href:"/"}).on("click",function(t){var i;return t.preventDefault(),i="../html/pop",i=-1===i.search(/http\:\/\//)?"/dotnet/date/html/"+i+".html":i,i+=$.salt(),$.get(i).done(function(t){return e.find(".close").click(),$("#mainer").append("<div>"+t+"</div>"),StartAnsQues(n)}).fail(function(){return $.info("error::通信失败！")})})}})):(a=e.getContentTxt(),a.length<5?void r("warning::正文应包含至少五个字符。"):a.length>500?void r("warning::正文内容长度最多不能超过五百个字符。"):(r("info::私信发送中..."),null!=(l=system.port.newMail)&&l.abort(),system.port.newMail=$.post("/api/mail.aspx?name=newMail",{username:$.parseSafe(i.data().name),content:$.parsePost(e.getContent())}).fail(function(){return r("error::同服务器通信失败。请于稍后重试。")}).done(function(n){return n.success?($.info("success::私信发送成功。"),$.hash({area:"mail"})):void r("error::"+n.result)})))}})})}).call(this);</script>
						</div>
					</div>
					<span class="clearfix"></span>
				</div>
