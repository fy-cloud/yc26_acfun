					...
					<div id="area-main-left" class="l">
						...
						<div id="list-guide-left">
							...
							<div class="part-guide-left active">
								...
								<div class="mainer hidden">
									<a href="page/mail.jsp" class="tab active"><i class="icon"></i>私信<span
					...
					<div id="area-main-right" class="r">
						<div id="area-cont-right">
							...
							<div id="block-title-banner">
								<p>私信</p>
								<div>
									<a href="http://www.acfun.cn/member/">AcFun</a><span class="d">Mail</span>
								</div>
							...
							<xmp id="temp-left-mail" class="hidden">&lt;div
							data-uid="[uid]" data-gid="[gid]" data-p2p="[p2p]"
							data-name="[name]" class="item [read]"&gt;&lt;div
							class="l"&gt;&lt;a ref="/member/user.aspx?uid=[uid]"
							target="_blank" class="thumb"&gt;&lt;img data-uid="[uid]"
							src="[avatar]" class="avatar"/&gt;&lt;span
							title="[verifiedTitle]" class="verified-ico
							verified-[verified]"&gt;&lt;/span&gt;&lt;/a&gt;&lt;/div&gt;&lt;div
							class="r"&gt;&lt;p class="name"&gt;[star][name] :&lt;span
							class="time"&gt;[time]&lt;/span&gt;&lt;/p&gt;&lt;p
							class="cont"&gt;[cont]&lt;a title="删除联系人"
							class="btn-delete-mail"&gt;[删除]&lt;/a&gt;&lt;/p&gt;&lt;/div&gt;&lt;span
							class="clearfix"&gt;&lt;/span&gt;&lt;/div&gt;</xmp>
							<xmp id="temp-right-mail" class="hidden">&lt;div
							data-mid="[mid]" class="item [from]"&gt;&lt;div
							class="l"&gt;&lt;a href="/member/user.aspx?uid=[uid]"
							target="_blank" class="thumb"&gt;&lt;img src="[avatar]"
							class="avatar"/&gt;&lt;span title="[verifiedTitle]"
							class="verified-ico
							verified-[verified]"&gt;&lt;/span&gt;&lt;/a&gt;&lt;/div&gt;&lt;div
							class="r"&gt;&lt;div class="cont"&gt;&lt;p title="播放信息"
							class="btn-sound-google"&gt;&lt;i class="icon
							icon-volume-up"&gt;&lt;/i&gt;&lt;/p&gt;&lt;span&gt;[cont]&lt;/span&gt;&lt;p
							class="time"&gt;&lt;span class="area-tool-mail"&gt;&lt;a
							title="举报信息" class="btn-report-mail"&gt;[举报]&lt;/a&gt;&lt;a
							title="删除信息"
							class="btn-delete-mail"&gt;[删除]&lt;/a&gt;&lt;/span&gt;[time]&lt;/p&gt;&lt;div
							class="subtail"&gt;&lt;/div&gt;&lt;div
							class="tail"&gt;&lt;/div&gt;&lt;/div&gt;&lt;/div&gt;&lt;span
							class="clearfix"&gt;&lt;/span&gt;&lt;/div&gt;</xmp>
							<div id="block-first" class="block">
								<div class="mainer">
									<p class="alert">
										<span class="r"><a id="btn-drift-mail"
											class="btn primary"><i class="icon icon-quote-left"></i>捡肥皂</a><a
											id="btn-newdrift-mail" href="#area=drift-new"
											class="btn primary"><i class="icon icon-quote-right"></i>丢肥皂</a></span>我们重新定义了私信系统，以使您能够更方便的同朋友们沟通与交流。<br>同时，您也可以通过新的肥皂系统来邂逅和结识陌生人。
									</p>
									<p class="alert warning">
										当被不良信息骚扰时，您可以举报发信者，或通过“写信”按钮右侧菜单将发信者纳入您的私信黑名单中。<br>同时，您也可以通过配置右侧菜单中“设定陌生人信息策略”选项，以拒收所有来自陌生人的私信。
									</p>
								</div>
							</div>
							<div id="block-second" class="block">
								<div class="banner">
									<div class="tab fixed">
										私信<span class="hint">/ 正与 <a class="name"
											href="http://www.acfun.cn/u/248830.aspx" target="_blank">AcFun弹幕视频网</a>
											通信中
										</span>
									</div>
									<div class="tab more group">
										<div id="btn-new-mail" title="发送新邮件" class="btn mini primary">
											<i class="icon icon-envelope"></i><a href="page/mail-new.jsp">写信</a>
										</div>
										<div id="btn-tool-mail" class="btn mini primary dropdown">
											<i class="icon icon-chevron-down"></i>
											<ul class="menu">
												<li id="btn-ban-mail"><i class="icon icon-ban"></i>屏蔽当前联系人</li>
												<li id="btn-manage-mail"><i class="icon icon-edit"></i>管理屏蔽列表</li>
												<li id="btn-config-mail"><i class="icon icon-cog"></i>设定陌生人信息策略</li>
												<li id="btn-delAllMails-mail"><i
													class="icon icon-trash-o"></i>清空收件箱</li>
											</ul>
										</div>
									</div>
								</div>
								<div class="mainer">
									<div id="block-main-mail">
										<div id="area-right-mail" class="l">
											<div style="height: 385px;" class="area-audio"
												id="area-mails-mail">
												<div data-mid="1481508699971" class="item from">
													<div class="l">
														<a href="http://www.acfun.cn/member/user.aspx?uid=248830"
															target="_blank" class="thumb"><img
															src="css/23110200a47bet7n.jpg" class="avatar"><span
															title="" class="verified-ico verified-undefined"></span></a>
													</div>
													<div class="r">
														<div class="cont">
															<p title="播放信息" class="btn-sound-google">
																<i class="icon icon-volume-up"></i>
															</p>
															<span>这是一条来自ACFUN猴山商城的站内信<br> <br>米娜~好久不见！双十二是个互相伤害的好日子。<br>
																<br>沃尔猴搓了搓手要预售新品啦，拍付后一个月内发货哦！<br> <br>上新优惠12月12号-16号期间全场85折，活动截止至16号下午5点~手慢无~<br>
																<br>官方taobao店铺地址：acmart.taobao.com<br> <br>一手周边上新资讯，请关注微博“AcFun沃尔猴”，么么哒~~
															</span>
															<p class="time">
																<span class="area-tool-mail"><a title="举报信息"
																	class="btn-report-mail">[举报]</a><a title="删除信息"
																	class="btn-delete-mail">[删除]</a></span>2016年12月12日(星期一) 10时11分
															</p>
															<div class="subtail"></div>
															<div class="tail"></div>
														</div>
													</div>
													<span class="clearfix"></span>
												</div>
												<div data-mid="1483509769277" class="item to ">
													<div class="l">
														<a href="http://www.acfun.cn/member/user.aspx?uid=8150118"
															target="_blank" class="thumb"><img
															src="img/avatar.jpg" class="avatar"><span title=""
															class="verified-ico verified-undefined"></span></a>
													</div>
													<div class="r">
														<div class="cont">
															<p title="播放信息" class="btn-sound-google">
															...
															<p class="time">
																<span class="area-tool-mail"><a title="举报信息"
																	class="btn-report-mail">[举报]</a><a title="删除信息"
																	class="btn-delete-mail">[删除]</a></span>1月4日(星期三) 14时02分
															</p>
															<div class="subtail"></div>
															<div class="tail"></div>
														</div>
									...
									<div id="area-left-mail" class="r">
										<div id="area-contact-mail">
											<div data-uid="248830" data-gid="1483509769277"
												data-p2p="8150118-248830" data-name="AcFun弹幕视频网"
												class="item readed active">
												<div class="l">
													<a ref="/member/user.aspx?uid=248830" target="_blank"
														class="thumb"><img data-uid="248830"
														src="css/23110200a47bet7n.jpg" class="avatar"><span
														title="" class="verified-ico verified-0"></span></a>
												</div>
												<div class="r">
													<p class="name">
														AcFun弹幕视频网 :<span class="time">1月4日</span>
													</p>
													<p class="cont">
														你好<a title="删除联系人" class="btn-delete-mail">[删除]</a>
													</p>
												</div>
												<span class="clearfix"></span>
											</div>
										</div>
										<div id="area-pager-mail"></div>
									</div>
									<span class="clearfix"></span>
								</div>
							</div>
					...
					<div class="unit unit-3">
						...
						<div class="b">
							<a id="" target="_blank" href="http://www.douyu.tv/" class="a-0">斗鱼直播</a><a
								id="" target="_blank" href="http://h.nimingban.com/" class="a-1">匿名版</a><a
								id="" target="_blank" href="http://lg.dianbo.me/index.php"
