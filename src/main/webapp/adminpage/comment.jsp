...
<div class="admin-main">
		<blockquote class="layui-elem-quote">
				<input type="text" name="username" autocomplete="off" placeholder="请输入资源ID" class="layui-btn-small">
		...
		<p><input style="width:0px;height:0px;"  id="uid" name="comment_id" readonly="readonly"/></p>
		</form>
				</div>
	...
	<script type="text/javascript" src="adminpage/js/comment.js"></script>
