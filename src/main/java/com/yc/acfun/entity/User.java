...
public class User {
	...
	public User(Integer user_id, String user_password, String user_name, String user_nickname, String user_head,
			String user_qq, String user_telephone, String user_email, String user_sex, String user_address,
			Integer user_state, String user_autograph, Date user_time) {
		super();
